...
for i in range(4160):
   if(i<4159):
       ...
       y000+=y00[i]
       y000/=4160
print("Zero count: ",y00[:4160].count(0)," One Count: ",y00[:4160].count(1),"Two Count: ",y00[:4160].count(2))
...
for i in range(4160):
   ...
   #print(l1)
b1=sum(l1)/4160
print("Zero count: ",x00[:4160].count(0)," One Count: ",x00[:4160].count(1))
...
for i in range(4160):
   ...
   l2.append(a1)
b2=sum(l2)/4160
print("Zero count: ",x01[:4160].count(0)," One Count: ",x01[:4160].count(1))
...
for i in range(4160):
   ...
   l4.append(a3)
b3=sum(l4)/4160
print("Zero count: ",x03[:4160].count(0)," One Count: ",x03[:4160].count(1))
...
for i in range(4160):
   ...
   l5.append(a4)
b4=sum(l5)/4160
print("Zero count: ",x04[:4160].count(0)," One Count: ",x04[:4160].count(1))
print("Icu:", b4)
...
for i in range(4160):
   ...
   l6.append(a5)
b5=sum(l6)/4160
print("Zero count: ",x05[:4160].count(0)," One Count: ",x05[:4160].count(1)," Two Count: ",x05[:4160].count(2))
