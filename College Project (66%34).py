...
for i in range(1980):
   if(i<1979):
       ...
       y000+=y00[i]
       y000/=1980
print("Zero count: ",y00[:1980].count(0)," One Count: ",y00[:1980].count(1))
...
for i in range(1980):
   ...
   #print(l1)
b1=sum(l1)/1980
print("Zero count: ",x00[:1980].count(0)," One Count: ",x00[:1980].count(1))
...
for i in range(1980):
   ...
   l2.append(a1)
b2=sum(l2)/1980
print("Zero count: ",x01[:1980].count(0)," One Count: ",x01[:1980].count(1))
...
for i in range(1980):
   ...
   l4.append(a3)
b3=sum(l4)/1980
print("Zero count: ",x03[:1980].count(0)," One Count: ",x03[:1980].count(1))
...
for i in range(1980):
   ...
   l6.append(a5)
b5=sum(l6)/1980
print("Zero count: ",x05[:1980].count(0)," One Count: ",x05[:1980].count(1)," Two Count: ",x05[:1980].count(2))
