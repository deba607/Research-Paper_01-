...
for i in range(3432):
   if(i<3431):
       ...
       y000+=y00[i]
       y000/=3432
print("Zero count: ",y00[:3432].count(0)," One Count: ",y00[:3432].count(1),"Two Count: ",y00[:3432].count(2))
...
for i in range(3432):
   ...
   #print(l1)
b1=sum(l1)/3432
print("Zero count: ",x00[:3432].count(0)," One Count: ",x00[:3432].count(1))
...
for i in range(3432):
   ...
   l2.append(a1)
b2=sum(l2)/3432
print("Zero count: ",x01[:3432].count(0)," One Count: ",x01[:3432].count(1))
...
for i in range(3432):
   ...
   l4.append(a3)
b3=sum(l4)/3432
print("Zero count: ",x03[:3432].count(0)," One Count: ",x03[:3432].count(1))
...
for i in range(3432):
   ...
   l5.append(a4)
b4=sum(l5)/3432
print("Zero count: ",x04[:3432].count(0)," One Count: ",x04[:3432].count(1))
print("Icu:", b4)
...
for i in range(3432):
   ...
   l6.append(a5)
b5=sum(l6)/3432
print("Zero count: ",x05[:3432].count(0)," One Count: ",x05[:3432].count(1)," Two Count: ",x05[:3432].count(2))
